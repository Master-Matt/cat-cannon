#!/usr/bin/env bash
# Shared environment setup for Cat Cannon launchers.
# Source this from run_app.sh / run_guardian.sh:  source "$(dirname ...)/_env.sh"
# It sets ROOT_DIR, PYTHON_BIN, DISPLAY/XAUTHORITY (for X11 from .desktop
# launchers), Qt plugin path, accessibility/thread tuning, and PYTHONPATH.
